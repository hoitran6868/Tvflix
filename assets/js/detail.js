...
const getCasts = function (castList) {
  ...
  for (let i = 0, length = castList.length; i < length && i < 10; i++) {
...
fetchDataFromServer(
  ...
  function (movie) {
    const {
      ...
      vote_average,
      releases: {
        countries: [{ certification }], // destructure object certification inside countries array
      },
      genres,
      overview,
      casts: { cast, crew },
      videos: { results: videos }, //destructure + alias
    } = movie;
